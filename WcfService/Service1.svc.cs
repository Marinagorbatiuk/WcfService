...
namespace WcfService
{
    ...
    public class Service1 : IService1
    {
        ...
        {
            addFunctionWCF.AddMaterialsToDB(materialsWCF);
        }
        ...
        public string[] WritingOff(WriteOffMaterialsWCF[] writeOffMaterials)
        {
            return addFunctionWCF.WritingOff(writeOffMaterials.ToList()).ToArray();
        }
        ...
        public MaterialsWCF[] GetListMaterials()
        {
            return getFunctionWCF.GetMaterials().ToArray();
        }

        public void UpdateMaterials(MaterialsWCF materialsWCF)
        {
            updateFunctionWCF.UpdateMaterials(materialsWCF);
        }
    }
}
